...
var BrowserRouter = function (_React$Component) {
  ...
  function BrowserRouter() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = history.createBrowserHistory(_this.props), _temp), possibleConstructorReturn(_this, _ret);
  }
...
var HashRouter = function (_React$Component) {
  ...
  function HashRouter() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = history.createHashHistory(_this.props), _temp), possibleConstructorReturn(_this, _ret);
  }
