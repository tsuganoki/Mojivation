...
var MemoryRouter = function (_React$Component) {
  ...
  function MemoryRouter() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = history.createMemoryHistory(_this.props), _temp), possibleConstructorReturn(_this, _ret);
  }
...
function Redirect(props) {
  return React.createElement(
    ...
    function (context$$1) {
      ...
      var to = history.createLocation(props.computedMatch ? typeof props.to === "string" ? generatePath(props.to, props.computedMatch.params) : Object.assign({}, props.to, {
